    ...
    <form action={formAction} className="flex flex-col gap-9">
      ...
      <SectionChamps titre="Travaux prévus" chapeau="Nature, durée, lieu.">
        ...
        <ChampBoard
          ...
          maxLength={5}
          className="max-w-[220px]"
          aide="Seuil R4512-7 : 400 h sur 12 mois."
      ...
      <SectionChamps
        ...
        chapeau="Obligatoire avant démarrage. Art. R4512-7 : visite des lieux par les deux chefs d'entreprise avant tout début de travaux."
      >
