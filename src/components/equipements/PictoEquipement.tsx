 ...
 * planche (INSTALLATION_ELECTRIQUE, AUTRE) : fallback lucide dans une
 * pastille, pour garder l'alignement des listes.
 *
...
export function PictoEquipement({
  ...
  if (!src) {
    const Fallback = categorie === "INSTALLATION_ELECTRIQUE" ? Zap : Wrench;
    return (
      <span
        aria-hidden
        className={cn(
