...
export const CODE_TRAVAIL_LEVAGE: Corpus = {
  ...
  articles: [
  {
    ...
    statut: "retenu",
    obligations: ["levage-epreuve-initiale-fonctionnement", "levage-examen-adequation-mise-en-service"],
  },
  {
    ref: "R. 4323-23",
    versionEnVigueur: "2008-05-01",
    ...
    lecture: "agent_verbatim",
    statut: "retenu",
    obligations: ["levage-examen-etat-conservation", "levage-vgp-accessoires-annuelle", "levage-vgp-annuelle-charges", "levage-vgp-semestrielle-chariot-gerbeur", "levage-vgp-semestrielle-personnes"],
  },
  {
    ref: "R. 4323-25",
    versionEnVigueur: "2008-05-01",
