...
export const ARRETE_1993_12_21_PORTES: Corpus = {
  ...
  articles: [
  {
    ...
    statut: "retenu",
    obligations: ["porte-auto-portail-piete-coulissant", "porte-auto-verification-initiale"],
  },
  {
    ...
    lecture: "agent_verbatim",
    statut: "retenu",
    obligations: ["porte-auto-dossier-maintenance", "porte-auto-verification-semestrielle"],
  },
  ],
};
