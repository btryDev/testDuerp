...
export const obligationsOrganisationPrevention: Obligation[] = [
  {
    ...
    referencesLegales: [
      ...
      },
      {
        source: "CODE_TRAVAIL",
        reference:
          "L. 2315-18 (conditions de la formation dont bénéficie le salarié désigné, par renvoi de L. 4644-1)",
        article: "L. 2315-18",
        url: "https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000036761949",
        versionConstatee: "2022-03-31",
        note: "Référence de contexte : elle fonde la formation, pas la désignation.",
      },
    ],
    periodicite: "autre",
