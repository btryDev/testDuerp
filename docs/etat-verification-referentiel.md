...
**7 domaines reposent intégralement sur des textes lus à la source avec verbatim** : `co_activite` (1), `formation_securite` (9), `froid` (8), `information_travailleurs` (2), `locaux_sociaux` (4), `organisation_prevention` (3), `secours` (3).

**6 domaines n'en ont aucune : `ascenseur` (7), `equipement_sous_pression` (6), `incendie` (17), `levage` (10), `porte_portail` (5), `stockage_dangereux` (6).** Chacune de leurs obligations cite au moins un texte ouvert dont rien n'a été relevé. C'est là que porte le travail de relevé, et nulle part ailleurs : ces textes ont été lus, ils n'ont pas été cités.
